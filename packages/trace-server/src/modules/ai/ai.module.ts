...
@Module({
  ...
  providers: [AiAnalyzeService, DailyReportService, AnomalyExplainService, GlmClientService, PromptService],
  exports: [AiAnalyzeService, DailyReportService, AnomalyExplainService],
})
